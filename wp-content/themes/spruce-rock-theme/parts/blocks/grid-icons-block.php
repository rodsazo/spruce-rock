...
<section class="grid-icons">
    <div class="container">
        <div class="grid-icons__content">
            ...
            ?>
            <div class="grid-icons__grid flow flow--24">
                <div class="grid-icons__grid-icons">               
                    <?php if($image_url): ?>
                    <img class="grid-icons__grid-icon" src="<?= esc_url($image_url); ?>">
                    <?php endif; ?>
                </div>
                <div class="grid-icons__grid-title t-24 t-trim">               
                    <?=$grid_with_icon['grid_icon_title']?>
                </div>
                <div class="grid-icons__grid-text t-16 t-trim">               
