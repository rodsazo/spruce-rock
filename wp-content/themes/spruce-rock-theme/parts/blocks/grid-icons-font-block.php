...
<section class="grid-icons-font">
    <div class="container">
        <div class="grid-icons-font__content flow">
            <div class="grid-icons-font__eyebrow grid-icons-font__bottom-40 t-caption t-trim | intersect fadeIn">
                <?=$grid_icons_font_eyebrow?>
            </div>
            <div class="grid-icons-font__title t-80 t-trim t-uppercase | intersect fadeIn">
            ...
            <div class="grid-icons-font__subcontent flow">
                ...
                <div class="grid-icons-font__grid flow flow--24 grid-icons-font__grid--shape-<?=$shape_index?>">
                    <div class="grid-icons-font__grid-icons | intersect fadeIn">
                        <?php if($image_url): ?>
                        <img class="grid-icons-font__grid-icon" src="<?= esc_url($image_url); ?>">
                        <?php endif; ?>
                    </div>

                    <div class="grid-icons-font__grid-title t-24 t-trim | intersect fadeIn">
                        <?=$grid_icon_font['grid_icon_font_title']?>
                    </div>

                    <div class="grid-icons-font__grid-text t-16 t-trim | intersect fadeIn">
